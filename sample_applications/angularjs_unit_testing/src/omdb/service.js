angular.module('omdb', [])
    .factory('omdbApi', function($http, $q) {
        ...
        service.movieDataById = function() {
            return "Tanmay";
        };
